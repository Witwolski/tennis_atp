...
sixmonths_dog = pd.read_sql_query(
    "Select * From Elo_AllMatches_Daily_Clay_Today where (Elo_Dog_Odds BETWEEN 2 AND 2.1) OR (Elo_Dog_Odds BETWEEN 2.4 AND 2.6) OR (Elo_Dog_Odds BETWEEN 3.1 AND 3.3) OR (Elo_Dog_Odds BETWEEN 3.4 AND 3.7)",
    con=devengine,
)
...
threemonths_dog = pd.read_sql_query(
    "Select * From Elo_AllMatches_Daily_Clay_Today where (Elo_Dog_Odds BETWEEN 2 AND 2.1) OR (Elo_Dog_Odds BETWEEN 2.5 AND 2.6) OR (Elo_Dog_Odds BETWEEN 3.1 AND 3.3) OR (Elo_Dog_Odds BETWEEN 3.4 AND 3.5) \
    OR (Elo_Dog_Odds BETWEEN 3.6 AND 3.7) OR (Elo_Dog_Odds BETWEEN 3.8 AND 3.9)",
    con=devengine,
)
...
twoyears_dog = pd.read_sql_query(
    "Select * From Elo_AllMatches_Daily_Clay_Today where  (Elo_Dog_Odds BETWEEN 1.8 AND 1.9) OR (Elo_Dog_Odds BETWEEN 2.5 AND 2.6) OR (Elo_Dog_Odds BETWEEN 3.1 AND 3.2) OR (Elo_Dog_Odds BETWEEN 3.6 AND 3.7)",
    con=devengine,
)
...
twoyears_fav = pd.read_sql_query(
    "Select * From Elo_AllMatches_Daily_Clay_Today where  (Elo_Fav_Odds BETWEEN 2 AND 2.1)",
    con=devengine,
)
