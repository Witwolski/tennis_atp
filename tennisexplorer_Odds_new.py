    ...
    def Main(url, current_date, suffix, check):
        ...
        for i, item in enumerate(tournament_idx_lst[:-1]):
            ...
            if (
                ...
                tournament_url = (
                    "https://www.tennisexplorer.com" + tournament_url.replace("'", "")
                )
                    ...
                    for c in range(item + 1, tournament_idx_lst[i + 1], 2):
                        ...
                        if len(test) > 1:
                            tournament_dict[tournament_name + str(item)][
                                ...
                                + "_"
                                + rows[c + 1]
                                .findAll("td", class_="score")[0]
                                .contents[0]
                                + "_"
                                + rows[c + 1]
                                .findAll("td", class_="score")[1]
                                .contents[0]
                                + "_"
                                + rows[c + 1]
                                .findAll("td", class_="score")[2]
                                .contents[0]
                                + "_"
                                + rows[c + 1]
                                .findAll("td", class_="score")[3]
                                .contents[0]
                                + "_"
                                + rows[c + 1]
                                .findAll("td", class_="score")[4]
                                .contents[0]
                            )
                        else:
                            tournament_dict[tournament_name + str(item)][
