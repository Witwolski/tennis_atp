...
data = pd.read_sql_query(
    "Select distinct Surface,Date,Sex,Player_1 as Winner, Player_2 as Loser, Player_1_Odds as Winner_Odds, Player_2_Odds as Loser_Odds FROM AllMatches where tournament not like '%UTR%' and date >='{}' ".format(
        date_six_months_ago
    ),
    con=devengine,
)
