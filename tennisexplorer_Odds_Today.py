    ...
    for key, value in tournament_dict.items():
        ...
        for i, date in value.items():
            for match in date:
                ...
                table = [['Date','Sex', 'Tournament', 'Player_1', 'Player_2','Player_1_Odds','Player_2_Odds','Surface'], [current_date,
                            suffix.replace('_', ''), key, player1, player2, player1odds,player2odds,Surface]]
                ...
                new_df=new_df[(new_df['Player_1_Odds']!=' ')&(new_df['Player_1']!='')&(new_df['Player_2']!='')]
                new_df.to_sql("TodaysMatches",con=devengine,if_exists='append',index=False)
